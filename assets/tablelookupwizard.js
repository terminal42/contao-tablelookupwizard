...
application.register('terminal42--tablelookupwizard', class extends Controller {
    ...
    async #fetchRecords(keywords) {
        ...
        this.selectionTarget.querySelectorAll('input[type="hidden"]').forEach(input => url.searchParams.append(input.name, input.value));
